package com.qlp.cloud.gateway.filter;
...
import com.qlp.cloud.common.core.exception.ValidateCodeException;
import com.qlp.cloud.common.core.util.R;
import com.qlp.cloud.common.core.util.WebUtils;
...
public class ValidateCodeGatewayFilter extends AbstractGatewayFilterFactory {
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ServerHttpRequest request = exchange.getRequest();            // 不是登录请求，直接向下执行
