package com.qlp.cloud.codegen.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import com.qlp.cloud.codegen.entity.ColumnEntity;
import com.qlp.cloud.codegen.entity.GenConfig;
import com.qlp.cloud.codegen.entity.TableEntity;
import com.qlp.cloud.common.core.constant.CommonConstants;
import com.qlp.cloud.common.core.exception.CheckedException;
...
public class GenUtils {
    ...
    public void generatorCode(GenConfig genConfig, Map<String, String> table,
        ...
        tableEntity.setLowerClassName(StringUtils.uncapitalize(className));        //列信息
        ...
        for (Map<String, String> column : columns) {
            ...
            columnEntity.setExtra(column.get("extra"));            //列名转换成Java属性名
            String attrName = columnToJava(columnEntity.getColumnName());
            columnEntity.setCaseAttrName(attrName);
            columnEntity.setLowerAttrName(StringUtils.uncapitalize(attrName));            //列的数据类型，转换成Java类型
        ...
        tableEntity.setColumns(columnList);        //没主键，则第一个字段为主键
        ...
        VelocityContext context = new VelocityContext(map);        //获取模板列表
