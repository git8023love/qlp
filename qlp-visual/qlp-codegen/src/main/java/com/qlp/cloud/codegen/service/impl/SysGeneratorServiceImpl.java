package com.qlp.cloud.codegen.service.impl;

import cn.hutool.core.io.IoUtil;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.qlp.cloud.codegen.entity.GenConfig;
import com.qlp.cloud.codegen.mapper.SysGeneratorMapper;
import com.qlp.cloud.codegen.service.SysGeneratorService;
import com.qlp.cloud.codegen.util.GenUtils;
...
public class SysGeneratorServiceImpl implements SysGeneratorService {
    ...
    public byte[] generatorCode(GenConfig genConfig) {
        ...
        ZipOutputStream zip = new ZipOutputStream(outputStream);        //查询表信息
