DROP DATABASE IF EXISTS `qlp`;CREATE DATABASE  `qlp` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;SET NAMES utf8;
SET FOREIGN_KEY_CHECKS = 0;USE `qlp`;-- ----------------------------
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_oauth_client_details` VALUES ('app', null, 'app', 'server', 'password,refresh_token', null, null, null, null, null, 'true'), ('daemon', null, 'daemon', 'server', 'password,refresh_token', null, null, null, null, null, 'true'), ('gen', null, 'gen', 'server', 'password,refresh_token', null, null, null, null, null, 'true'), ('qlp', null, 'qlp', 'server', 'password,refresh_token,authorization_code,client_credentials', 'http://localhost:4040/sso1/login,http://localhost:4041/sso1/login', null, null, null, null, 'true'), ('test', null, 'test', 'server', 'password,refresh_token', null, null, null, null, null, 'true');
COMMIT;-- ----------------------------
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED;SET FOREIGN_KEY_CHECKS = 1;
